...
class DatasetConfig(object):
    ...
    '''
    def __init__(self, dataset,df_train, df_val, df_test, target_name):
        '''
        Constructor
        ...
        self.features_name = self.dataset.drop(columns = [target_name]).columns.tolist()
        ...
        def correlated_score():
            ...
            '''
            df_corr = self.dataset.corr(method='pearson')
            df_corr = df_corr.abs()
            ...
            dict_corr.pop(self.target_name)
            return dict_corr
